...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`th`__: pointer to theme (return value of: 'lv_theme_init_xxx()')"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`name`__: the name of the theme element to apply. E.g. `LV_THEME_BTN`"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " The styles from the base them will be added before the styles of the current theme."]
    #[doc = " Arbitrary long chain of themes can be created by setting base themes."]
    #[doc = " - __`new_theme`__: pointer to theme which base should be set"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " The apply callback is used to add styles to different objects"]
    #[doc = " - __`theme`__: pointer to theme which callback should be set"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`flags`__: ORed flags starting with `LV_THEME_DEF_FLAG_...`"]
