...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new object mask"]
    #[doc = " - __`copy`__: pointer to a object mask object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`objmask`__: pointer to an Object mask object"]
    #[doc = " - __`mask`__: pointer to created mask (returned by `lv_objmask_add_mask`)"]
    #[doc = " - __`param`__: an initialized mask parameter (initialized by `lv_draw_mask_line/angle/.../_init`)"]
