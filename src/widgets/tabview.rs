...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new tab"]
    #[doc = " - __`copy`__: pointer to a tab object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`tabview`__: pointer to Tab view object where to ass the new tab"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Delete all children of a tab created by `lv_tabview_add_tab`."]
