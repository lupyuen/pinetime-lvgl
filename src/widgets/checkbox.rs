...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new check box"]
    #[doc = " - __`copy`__: pointer to a check box object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`txt`__: the text of the check box. NULL to refresh with the current text."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`checked`__: true: make the check box checked; false: make it unchecked"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`cb`__: pointer to a check box object"]
    #[doc = " - __`state`__: the new state of the check box (from lv_btn_state_t enum)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_checkbox_is_checked(cb: *const lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get whether the check box is inactive or not."]
    #[doc = " - __`cb`__: pointer to a check box object"]
    #[doc = " Return: true: inactive; false: not inactive"]
    pub fn lv_checkbox_is_inactive(cb: *const lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the current state of a check box"]
    #[doc = " - __`cb`__: pointer to a check box object"]
    #[doc = " Return: the state of the check box (from lv_btn_state_t enum)"]
    pub fn lv_checkbox_get_state(cb: *const lv_obj_t) -> lv_btn_state_t;
}
