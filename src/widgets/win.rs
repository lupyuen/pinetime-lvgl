...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new window"]
    #[doc = " - __`copy`__: pointer to a window object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`img_src`__: an image source ('lv_img_t' variable, path to file or a symbol)"]
    #[doc = " Return: pointer to the created button object"]
    pub fn lv_win_add_btn_right(win: *mut lv_obj_t, img_src: *const ::cty::c_void)
        -> *mut lv_obj_t;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`btn`__: pointer to the control button on the widows header"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`width`__: width of the control button. 0: to make them square automatically."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`w`__: width"]
    #[doc = " - __`h`__: height (the window will be higher with the height of the header)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`sb_mode`__: the new scroll bar mode from  'lv_scrollbar_mode_t'"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get drag status of a window. If set to 'true' window can be dragged like on a PC."]
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " Return: whether window is draggable"]
    pub fn lv_win_get_drag(win: *const lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Focus on an object. It ensures that the object will be visible in the window."]
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`obj`__: pointer to an object to focus (must be in the window)"]
    #[doc = " - __`anim_en`__: LV_ANIM_ON focus with an animation; LV_ANIM_OFF focus without animation"]
    pub fn lv_win_focus(win: *mut lv_obj_t, obj: *mut lv_obj_t, anim_en: lv_anim_enable_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Scroll the window horizontally"]
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`dist`__: the distance to scroll (< 0: scroll right; > 0 scroll left)"]
    pub fn lv_win_scroll_hor(win: *mut lv_obj_t, dist: lv_coord_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Scroll the window vertically"]
    #[doc = " - __`win`__: pointer to a window object"]
    #[doc = " - __`dist`__: the distance to scroll (< 0: scroll down; > 0 scroll up)"]
    pub fn lv_win_scroll_ver(win: *mut lv_obj_t, dist: lv_coord_t);
}
