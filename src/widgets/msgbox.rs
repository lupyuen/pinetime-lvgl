...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new message box"]
    #[doc = " - __`copy`__: pointer to a message box object, if not NULL then the new object will be copied from"]
    #[doc = " it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`txt`__: a '\\0' terminated character string which will be the message box text"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`anim_time`__: animation length in  milliseconds (0: no animation)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`mbox`__: pointer to a message box object"]
    #[doc = " - __`delay`__: a time (in milliseconds) to wait before delete the message box"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Set whether recoloring is enabled. Must be called after `lv_msgbox_add_btns`."]
    #[doc = " - __`mbox`__: pointer to message box object"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " @remarks return value will be NULL unless `lv_msgbox_add_btns` has been already called"]
