...
impl lv_bar_ext_t {
    ...
    #[inline]
    pub fn new_bitfield_1(type_: u8) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
...
impl lv_slider_ext_t {
    ...
    #[inline]
    pub fn new_bitfield_1(dragging: u8) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new slider"]
    #[doc = " - __`copy`__: pointer to a slider object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_slider_set_value(slider: *mut lv_obj_t, value: i16, anim: lv_anim_enable_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`anim`__: LV_ANIM_ON: set the value with an animation; LV_ANIM_OFF: change the value immediately"]
    pub fn lv_slider_set_left_value(slider: *mut lv_obj_t, left_value: i16, anim: lv_anim_enable_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_slider_set_range(slider: *mut lv_obj_t, min: i16, max: i16);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_slider_set_anim_time(slider: *mut lv_obj_t, anim_time: u16);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Make the slider symmetric to zero. The indicator will grow from zero instead of the minimum"]
    #[doc = " position."]
    #[doc = " - __`slider`__: pointer to a slider object"]
    #[doc = " - __`en`__: true: enable disable symmetric behavior; false: disable"]
    pub fn lv_slider_set_type(slider: *mut lv_obj_t, type_: lv_slider_type_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_slider_get_left_value(slider: *const lv_obj_t) -> i16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the minimum value of a slider"]
    #[doc = " - __`slider`__: pointer to a slider object"]
    #[doc = " Return: the minimum value of the slider"]
    pub fn lv_slider_get_min_value(slider: *const lv_obj_t) -> i16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the maximum value of a slider"]
    #[doc = " - __`slider`__: pointer to a slider object"]
    #[doc = " Return: the maximum value of the slider"]
    pub fn lv_slider_get_max_value(slider: *const lv_obj_t) -> i16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_slider_get_anim_time(slider: *mut lv_obj_t) -> u16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get whether the slider is symmetric or not."]
    #[doc = " - __`slider`__: pointer to a bar object"]
    #[doc = " Return: true: symmetric is enabled; false: disable"]
    pub fn lv_slider_get_type(slider: *mut lv_obj_t) -> lv_slider_type_t;
}
