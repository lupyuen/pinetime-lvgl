...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new keyboard"]
    #[doc = " - __`copy`__: pointer to a keyboard object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`kb`__: pointer to a Keyboard object"]
    #[doc = " - __`en`__: true: show cursor on the current text area, false: hide cursor"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`map`__: pointer to a string array to describe the map."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Set the button control map (hidden, disabled etc.) for the keyboard. The"]
    #[doc = " control map array will be copied and so may be deallocated after this"]
    #[doc = " function returns."]
    #[doc = " - __`kb`__: pointer to a keyboard object"]
    #[doc = " - __`mode`__: keyboard ctrl map to alter 'lv_keyboard_mode_t'"]
    #[doc = " - __`ctrl_map`__: pointer to an array of `lv_btn_ctrl_t` control bytes."]
    #[doc = "                 See: `lv_btnmatrix_set_ctrl_map` for more details."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_keyboard_get_map_array(kb: *const lv_obj_t) -> *mut *const ::cty::c_char;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
