...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new bar"]
    #[doc = " - __`copy`__: pointer to a bar object, if not NULL then the new object will be copied from it"]
