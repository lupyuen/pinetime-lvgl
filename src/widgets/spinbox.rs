...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new spinbox"]
    #[doc = " - __`copy`__: pointer to a spinbox object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`spinbox`__: pointer to spinbox"]
    #[doc = " - __`digit_count`__: number of digit excluding the decimal separator and the sign"]
    #[doc = " - __`separator_position`__: number of digit before the decimal point. If 0, decimal point is not"]
    #[doc = " shown"]
