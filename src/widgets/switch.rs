...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new switch"]
    #[doc = " - __`copy`__: pointer to a switch object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_switch_set_anim_time(sw: *mut lv_obj_t, anim_time: u16);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the state of a switch"]
    #[doc = " - __`sw`__: pointer to a switch object"]
    #[doc = " Return: false: OFF; true: ON"]
    pub fn lv_switch_get_state(sw: *const lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the animation time of the switch"]
    #[doc = " - __`sw`__: pointer to a  switch object"]
    #[doc = " Return: style pointer to a style"]
    pub fn lv_switch_get_anim_time(sw: *const lv_obj_t) -> u16;
}
