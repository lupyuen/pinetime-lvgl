...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new list"]
    #[doc = " - __`copy`__: pointer to a list object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`img_fn`__: file name of an image before the text (NULL if unused)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`index`__: pointer to a the button's index in the list, index must be 0 <= index <"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`list`__: pointer to a list object"]
    #[doc = " - __`sb_mode`__: the new mode from 'lv_page_sb_mode_t' enum"]
    pub fn lv_list_set_scrollbar_mode(list: *mut lv_obj_t, mode: lv_scrollbar_mode_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Enable the scroll propagation feature. If enabled then the List will move its parent if there is"]
    ...
    pub fn lv_list_set_scroll_propagation(list: *mut lv_obj_t, en: bool);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Set scroll animation duration on 'list_up()' 'list_down()' 'list_focus()'"]
    #[doc = " - __`list`__: pointer to a list object"]
    #[doc = " - __`anim_time`__: duration of animation [ms]"]
    pub fn lv_list_set_anim_time(list: *mut lv_obj_t, anim_time: u16);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`list`__: pointer to a list object"]
    #[doc = " - __`prev_btn`__: pointer to button. Search the next after it."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`list`__: pointer to a list object"]
    #[doc = " - __`prev_btn`__: pointer to button. Search the previous before it."]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`list`__: pointer to a list object. If NULL, assumes btn is part of a list."]
    #[doc = " - __`btn`__: pointer to a list element (button)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_list_get_scrollbar_mode(list: *const lv_obj_t) -> lv_scrollbar_mode_t;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the scroll propagation property"]
    #[doc = " - __`list`__: pointer to a List"]
    #[doc = " Return: true or false"]
    pub fn lv_list_get_scroll_propagation(list: *mut lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the scroll propagation property"]
    #[doc = " - __`list`__: pointer to a List"]
    #[doc = " Return: true or false"]
    pub fn lv_list_get_edge_flash(list: *mut lv_obj_t) -> bool;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get scroll animation duration"]
    #[doc = " - __`list`__: pointer to a list object"]
    #[doc = " Return: duration of animation [ms]"]
    pub fn lv_list_get_anim_time(list: *const lv_obj_t) -> u16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`anim`__: LV_ANOM_ON: scroll with animation, LV_ANIM_OFF: without animation"]
