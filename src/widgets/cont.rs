...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new container"]
    #[doc = " - __`copy`__: pointer to a container object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_cont_set_fit2(cont: *mut lv_obj_t, hor: lv_fit_t, ver: lv_fit_t);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
