...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new roller"]
    #[doc = " - __`copy`__: pointer to a roller object, if not NULL then the new object will be copied from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`mode`__: `LV_ROLLER_MODE_NORMAL` or `LV_ROLLER_MODE_INFINITE`"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`align`__: - one of lv_label_align_t values (left, right, center)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`anim`__: LV_ANOM_ON: set with animation; LV_ANIM_OFF set immediately"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Allow automatically setting the width of roller according to it's content."]
    #[doc = " - __`roller`__: pointer to a roller object"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_roller_set_anim_time(roller: *mut lv_obj_t, anim_time: u16);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_roller_get_anim_time(roller: *const lv_obj_t) -> u16;
}
