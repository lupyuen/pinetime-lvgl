...
impl lv_imgbtn_ext_t {
    ...
    #[inline]
    pub fn new_bitfield_1(tiled: u8) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new image button"]
    #[doc = " - __`copy`__: pointer to a image button object, if not NULL then the new object will be copied from"]
    #[doc = " it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`state`__: for which state set the new image (from `lv_btn_state_t`) `"]
    #[doc = " - __`src`__: pointer to an image source (a C array or path to a file)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_imgbtn_set_checkable(imgbtn: *mut lv_obj_t, tgl: bool);
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`imgbtn`__: pointer to an image button object"]
    #[doc = " - __`state`__: the state where to get the image (from `lv_btn_state_t`) `"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    pub fn lv_imgbtn_get_state(imgbtn: *const lv_obj_t) -> lv_btn_state_t;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get the toggle enable attribute of the image button"]
    #[doc = " - __`imgbtn`__: pointer to a image button object"]
    #[doc = " Return: true: toggle enabled, false: disabled"]
    pub fn lv_imgbtn_get_checkable(imgbtn: *const lv_obj_t) -> bool;
}
