...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`par`__: pointer to an object, it will be the parent of the new chart background"]
    #[doc = " - __`copy`__: pointer to a chart background object, if not NULL then the new object will be copied"]
    #[doc = " from it"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__: pointer to a graph background object"]
    #[doc = " - __`axis`__: `LV_CHART_AXIS_PRIMARY_Y` or `LV_CHART_AXIS_SECONDARY_Y`"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__: pointer to a chart object"]
    #[doc = " - __`type`__: new type of the chart (from 'lv_chart_type_t' enum)"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__: pointer to chart object"]
    #[doc = " - __`ser`__: pointer to a data series on 'chart'"]
    #[doc = " - __`y_array`__: array of 'lv_coord_t' points (with 'points count' elements )"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`major_tick_len`__: the length of the major tick or `LV_CHART_TICK_LENGTH_AUTO` to set automatically"]
    #[doc = "                       (where labels are added)"]
    #[doc = " - __`minor_tick_len`__: the length of the minor tick, `LV_CHART_TICK_LENGTH_AUTO` to set automatically"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__:             pointer to a chart object"]
    #[doc = " - __`list_of_values`__:    list of string values, terminated with \\n, except the last"]
    #[doc = " - __`num_tick_marks`__:    if list_of_values is NULL: total number of ticks per axis"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__:             pointer to a chart object"]
    #[doc = " - __`ser`__:               pointer to a data series on 'chart'"]
    #[doc = " - __`id`__:                the index of the x point in the data array"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " NOTE: It is the users responsibility to make sure the point_cnt matches the external array size."]
    #[doc = " - __`chart`__:             pointer to a chart object"]
    #[doc = " - __`ser`__:               pointer to a data series on 'chart'"]
    #[doc = " - __`array`__:             external array of points for chart"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Set an individual point value in the chart series directly based on index"]
    #[doc = " - __`chart`__:             pointer to a chart object"]
    #[doc = " - __`ser`__:               pointer to a data series on 'chart'"]
    #[doc = " - __`value`__:             value to assign to array point"]
    #[doc = " - __`id`__:                the index of the x point in the array"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " get the current index of the x-axis start point in the data array"]
    #[doc = " - __`ser`__:               pointer to a data series on 'chart'"]
    #[doc = " Return:                  the index of the current x start point in the data array"]
    pub fn lv_chart_get_x_start_point(ser: *mut lv_chart_series_t) -> u16;
}
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    #[doc = " Get an individual point value in the chart series directly based on index"]
    #[doc = " - __`chart`__:             pointer to a chart object"]
    #[doc = " - __`ser`__:               pointer to a data series on 'chart'"]
    #[doc = " - __`id`__:                the index of the x point in the array"]
...
#[lvgl_macros::safe_wrap(attr)] extern "C" {
    ...
    #[doc = " - __`chart`__: pointer to a chart object"]
    #[doc = " - __`ser`__: pointer to series"]
    #[doc = " Return: `LV_CHART_AXIS_PRIMARY_Y` or `LV_CHART_AXIS_SECONDARY_Y`"]
